...
class SettingsDialogBase ( wx.Dialog ):
    ...
    def __init__( self, parent ):
        wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"交互式 Html Bom", pos = wx.DefaultPosition, size = wx.Size( 463,497 ), style = wx.DEFAULT_DIALOG_STYLE|wx.STAY_ON_TOP|wx.BORDER_DEFAULT )
...
class SettingsDialogPanel ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 400,300 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        self.m_button43 = wx.Button( self, wx.ID_ANY, u"取消", wx.DefaultPosition, wx.DefaultSize, 0|wx.BORDER_DEFAULT )
...
class HtmlSettingsPanelBase ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        self.darkModeCheckbox = wx.CheckBox( self, wx.ID_ANY, u"黑暗模式", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.showFabricationCheckbox = wx.CheckBox( self, wx.ID_ANY, u"显示装配层", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.highlightPin1Checkbox = wx.CheckBox( self, wx.ID_ANY, u"高亮第一个引脚", wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        bomDefaultViewChoices = [ u"仅 BOM", u"BOM 在左边, 图纸在右边", u"BOM 在顶部, 图纸在底部" ]
        ...
        layerDefaultViewChoices = [ u"仅顶层", u"顶层和顶层", u"仅底层" ]
        ...
        self.openBrowserCheckbox = wx.CheckBox( self, wx.ID_ANY, u"打开浏览器", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class GeneralSettingsPanelBase ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        sbSizer6 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"BOM 目的地" ), wx.VERTICAL )
        ...
        self.bomDirPicker = wx.DirPickerCtrl( sbSizer6.GetStaticBox(), wx.ID_ANY, wx.EmptyString, u"选择BOM文件夹", wx.DefaultPosition, wx.DefaultSize, wx.DIRP_SMALL|wx.DIRP_USE_TEXTCTRL|wx.BORDER_SIMPLE )
        ...
        sortingSizer = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"元件排列顺序" ), wx.VERTICAL )
        ...
        self.m_button1 = wx.Button( sortingSizer.GetStaticBox(), wx.ID_ANY, u"上", wx.DefaultPosition, wx.Size( 30,30 ), 0|wx.BORDER_DEFAULT )
        bSizer5.Add( self.m_button1, 0, wx.ALL, 5 )
        
        self.m_button2 = wx.Button( sortingSizer.GetStaticBox(), wx.ID_ANY, u"下", wx.DefaultPosition, wx.Size( 30,30 ), 0|wx.BORDER_DEFAULT )
        ...
        self.blacklistVirtualCheckbox = wx.CheckBox( blacklistSizer.GetStaticBox(), wx.ID_ANY, u"虚拟元件黑名单", wx.DefaultPosition, wx.DefaultSize, 0 )
        self.blacklistVirtualCheckbox.SetValue(True) 
        blacklistSizer.Add( self.blacklistVirtualCheckbox, 0, wx.ALL, 5 )
        
        self.blacklistEmptyValCheckbox = wx.CheckBox( blacklistSizer.GetStaticBox(), wx.ID_ANY, u"将值为空的元件列入黑名单", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class ExtraFieldsPanelBase ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        sbSizer7 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"网表或 xml 文件" ), wx.VERTICAL )
        
        self.netlistFilePicker = wx.FilePickerCtrl( sbSizer7.GetStaticBox(), wx.ID_ANY, wx.EmptyString, u"选择一个文件", u"网表和 xml 文件 (*.net; *.xml)|*.net;*.xml", wx.DefaultPosition, wx.DefaultSize, wx.FLP_DEFAULT_STYLE|wx.FLP_FILE_MUST_EXIST|wx.FLP_OPEN|wx.FLP_SMALL|wx.FLP_USE_TEXTCTRL|wx.BORDER_SIMPLE )
        ...
        self.m_button1 = wx.Button( extraFieldsSizer.GetStaticBox(), wx.ID_ANY, u"上", wx.DefaultPosition, wx.Size( 30,30 ), 0|wx.BORDER_DEFAULT )
        bSizer5.Add( self.m_button1, 0, wx.ALL, 5 )
        
        self.m_button2 = wx.Button( extraFieldsSizer.GetStaticBox(), wx.ID_ANY, u"下", wx.DefaultPosition, wx.Size( 30,30 ), 0|wx.BORDER_DEFAULT )
        bSizer5.Add( self.m_button2, 0, wx.ALL, 5 )
        ...
        sbSizer8 = wx.StaticBoxSizer( wx.StaticBox( self, wx.ID_ANY, u"DNP 字段名称" ), wx.VERTICAL )
        ...
        dnpFieldBoxChoices = []
        self.dnpFieldBox = wx.ComboBox( sbSizer8.GetStaticBox(), wx.ID_ANY, u"-没有-", wx.DefaultPosition, wx.DefaultSize, dnpFieldBoxChoices, wx.CB_READONLY|wx.CB_SORT|wx.BORDER_NONE )
