...
class InteractiveHtmlBomPlugin(pcbnew.ActionPlugin):
    ...
    def defaults(self):
        ...
        self.description should be a comprehensive description
          of the plugin
        """
        self.name = "生成交互式 HTML BOM"
        self.category = "Read PCB"
        self.pcbnew_icon_support = hasattr(self, u"show_toolbar_button")
        self.show_toolbar_button = True
        self.icon_file_name = os.path.join(
                os.path.dirname(__file__), 'icon.png')
        self.description = u"Generate interactive HTML page that contains BOM " \
                           u"table and pcb drawing."
